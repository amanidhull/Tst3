...
<b>✥ ɪ ᴀᴍ ᴀ ᴘᴏᴡᴇʀғᴜʟ ᴀᴜᴛᴏ ғɪʟᴛᴇʀ ʙᴏᴛ.
✥ ɪ ɢɪᴠᴇ ᴍᴏᴠɪᴇ sᴇʀɪᴇs ʜᴀʟғ ᴏғ sᴇᴄᴏɴᴅs.
✥ ɪ ᴀᴍ sᴜᴘᴇʀғᴀsᴛ ᴡᴏʀᴋɪɴɢ.
✥ sᴍᴏᴏᴛʜ ᴜsᴇʀ ᴇxᴘᴇʀɪᴇɴᴄᴇ.</b>"""
...
ᴡᴇ ʜᴀᴠᴇ ᴅᴇᴠɪᴅᴇᴅ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ɢʀᴏᴜᴘ ᴏᴡɴᴇʀꜱ ᴀɴᴅ ʙᴏᴛ ᴜꜱᴇʀꜱ.</b>"""
    ...
    BLACKLIST = ['tamilblaster', 'filmyzilla', 'streamershub', 'xyz', 'cine', 'www', 'http', 'https',
                ...
                'filmy', 'films', 'cinema', 'club', 'apd', 'F-Press', 'GDTOT', 'mkv', 'NETFLIX_OFFICIAL',
...
‣ ᴄʀᴇᴀᴛᴏʀ : <a href=https://t.me/Amani_jii>ᗩᴍᴀɴɪ</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  : ʜᴇʀᴏᴋᴜ
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href=https://t.me/MSLANDERSTALK_BOT>AMANI</a>"""
...
💵 ᴜᴘɪ ɪᴅ - Currently Payment Service Is Off 
...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code>v2.7.1 [ Sᴛᴀʙʟᴇ ]</code></b>"""
    ...
    LOGO = """𝗕𝗢𝗧 𝗗𝗘𝗣𝗟𝗢𝗬𝗘𝗗 𝗦𝗨𝗖𝗖𝗘𝗦𝗦, 𝗧𝗛𝗔𝗡𝗞𝗦 𝗧𝗢 𝗔𝗠𝗔𝗡𝗜"""                                                                                  
